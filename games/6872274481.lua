...
run(function()
	...
	if not canDebug then
		local cheatenginelib = loadstring(downloadFile('Coo/libraries/cheatenginelib.lua'), 'cheatenginelib')(vape, vapeEvents, entitylib)
		require = function(v) 
...
run(function()
	...
	local packages = httpService:JSONDecode(downloadFile('Coo/profiles/packages.json'))	
...
run(function()
    ...
    -- Writes Coo/pa_debug.txt. For each shot it records what PA
    ...
    local paShotId = 0
    local paDebugFile = 'Coo/pa_debug.txt'
    local paWeaponStats = {}
...
run(function()
    ...
    vape.Components.HotbarList = function(optionsettings, children, api)
        ...
        textbuttonicon.Image = getcustomasset('Coo/assets/new/add.png')
            ...
            local mounted = bedwars.Roact.mount(create('BillboardGui', {
                ...
                create('Frame', {
                    ...
                    create('ImageLabel', {
                        ...
                        BackgroundTransparency = 1,
                        Image = getcustomasset('Coo/assets/new/blur.png'),
    	...
    	Function = function(callback)
    		if callback then
    			...
    			if CUSTOM_PACKS[Pack.Value] then
    				url = 'https://raw.githubusercontent.com/chinse394-netizen/Coo/main/texturepacks/' .. Pack.Value .. '.lua'
    			else
...
run(function()
	...
	local debugFile = 'Coo/healthdrop_debug.txt'
